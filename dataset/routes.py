...
routes = pd.read_csv(r'German bahn/dataset/routes.csv')
stops = pd.read_csv(r'German bahn/dataset/stops.csv')
trips = pd.read_csv(r'German bahn/dataset/trips.csv')
stop_times = pd.read_csv(r'German bahn/dataset/stop_times.csv')
...
df.to_csv(r'German bahn/dataset/routes.csv', index=False)
